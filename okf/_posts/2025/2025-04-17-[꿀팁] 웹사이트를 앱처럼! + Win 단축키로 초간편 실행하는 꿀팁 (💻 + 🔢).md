...
description: "Chrome과 Edge에서 자주 쓰는 웹사이트를 독립 앱으로 설치하고, 작업 표시줄에 고정한 뒤 Win+숫자 단축키로 즉시 실행하는 Windows 생산성 팁을 소개한다."
date: "2025-04-17"
tags:
  - "꿀팁"
  - "Tools"
resource: "https://velog.io/@euisuk-chung/꿀팁-웹사이트를-앱처럼-Win-단축키로-초간편-실행하는-꿀팁"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T21:23:33Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/꿀팁-웹사이트를-앱처럼-Win-단축키로-초간편-실행하는-꿀팁"
    title: "[꿀팁] 웹사이트를 앱처럼! + Win 단축키로 초간편 실행하는 꿀팁 (💻 + 🔢)"
