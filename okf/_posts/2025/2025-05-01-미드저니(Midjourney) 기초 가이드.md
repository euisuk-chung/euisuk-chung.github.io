...
description: "텍스트 프롬프트로 이미지를 만드는 Midjourney의 가입과 요금제, 웹 Create 페이지와 Creation Actions 사용법, 주요 파라미터와 프롬프트 가중치, V6·V6.1·V7·Niji 6 버전 선택 기준을 단계별로 안내한다."
date: "2025-05-01"
tags:
  - "Midjourney"
  - "Prompt Engineering"
