...
description: "API의 요청·응답 구조와 동기/비동기 통신, REST·GraphQL·gRPC·JSON-RPC 형식, HTTP·WebSocket·SSE·STDIO 프로토콜, FastAPI를 설명하고 Python requests로 Kakao 검색 API를 호출하는 예제를 다룬다."
date: "2025-04-27"
tags:
  - "개념정리"
  - "IT지식"
  - "Network"
  - "Python"
resource: "https://velog.io/@euisuk-chung/개념-API에-대해서-이해해보자"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:25:23Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/개념-API에-대해서-이해해보자"
    title: "[개념] API에 대해서 이해해보자!"
