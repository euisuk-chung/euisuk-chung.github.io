...
description: "Windows에서 VS Code를 제거하고 update.code.visualstudio.com URL을 편집해 특정 버전의 유저/시스템 설치 파일을 받는 방법과 update.mode 설정으로 자동 업데이트를 막는 방법을 설명한다."
date: "2025-03-06"
tags:
  - "꿀팁"
  - "Tools"
  - "환경설정"
resource: "https://velog.io/@euisuk-chung/꿀팁-VS-Code-특정-버전-설치-및-다운그레이드-방법"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:32:04Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/꿀팁-VS-Code-특정-버전-설치-및-다운그레이드-방법"
    title: "[꿀팁] VS Code 특정 버전 설치 및 다운그레이드 방법"
