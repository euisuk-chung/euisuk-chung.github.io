...
description: "Pandas to_pickle/read_pickle에서 지원하는 gzip, bz2, zip, xz 압축 방식의 압축률과 속도, 호환성을 비교하고 상황별로 어떤 방식을 선택할지 예제 코드와 함께 정리한다."
date: "2025-03-04"
tags:
  - "Pandas"
  - "Python"
resource: "https://velog.io/@euisuk-chung/Pandas-pickle파일의-압축-방식-비교-및-활용-가이드"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:32:25Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/Pandas-pickle파일의-압축-방식-비교-및-활용-가이드"
    title: "[Pandas] 판다스 피클(.pkl) 파일의 압축 방식 비교"
