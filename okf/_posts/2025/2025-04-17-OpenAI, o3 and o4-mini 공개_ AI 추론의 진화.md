...
description: "OpenAI 라이브스트림을 바탕으로 o3·o4-mini의 도구 기반 연쇄 추론 구조, AIME·Codeforces·SWE-bench 벤치마크, 데모 사례, 비용 대비 효율, 가격표와 오픈소스 Codex CLI까지 정리한다."
date: "2025-04-17"
tags:
  - "OpenAI"
  - "AI Agent"
