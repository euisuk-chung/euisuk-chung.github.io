...
description: "Rust 기반 Python 환경 관리 도구 UV의 설치, Python 버전 관리, uv init·venv·sync, uv add와 uv tool·uvx의 차이, 실무 프로젝트 템플릿과 기존 도구 대비 성능까지 정리한다."
date: "2025-04-24"
tags:
  - "환경설정"
  - "Python"
  - "Tools"
resource: "https://velog.io/@euisuk-chung/UV-내가-참고하려고-작성한-UV-가이드"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T21:23:21Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/UV-내가-참고하려고-작성한-UV-가이드"
    title: "💻 내가 보려고 작성한 UV 완벽 가이드"
