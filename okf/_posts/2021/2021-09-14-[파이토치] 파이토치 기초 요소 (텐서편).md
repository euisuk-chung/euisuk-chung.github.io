...
description: "torch.tensor로 스칼라, 벡터, 행렬, 텐서를 정의하고 shape를 확인하는 방법과 add, sub, mul, div, dot, matmul 등 기본 연산을 예제 코드로 정리합니다."
date: "2021-09-14"
tags:
  - "PyTorch"
  - "딥러닝"
  - "Python"
resource: "https://velog.io/@euisuk-chung/파이토치-기초-요소-텐서편"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:18:00Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/파이토치-기초-요소-텐서편"
    title: "[파이토치] 파이토치 기초 요소 (텐서편)"
