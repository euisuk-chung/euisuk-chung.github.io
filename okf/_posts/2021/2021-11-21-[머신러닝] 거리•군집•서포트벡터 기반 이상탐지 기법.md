...
description: "강필성 교수님 강의를 바탕으로 kNN 거리 기반, K-Means와 PCA·Auto-Encoder 재구성 기반, One-class SVM과 SVDD, Isolation Forest까지 이상탐지 기법의 핵심 아이디어와 이상치 점수 정의를 정리한다."
date: "2021-11-21"
tags:
  - "이상탐지"
  - "머신러닝"
  ...
  - "강의노트"
  - "비지도학습"
resource: "https://velog.io/@euisuk-chung/머신러닝차원축소-이상치-탐지-기법-거리군집서포트벡터-기반-이상치탐지"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T21:26:19Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/머신러닝차원축소-이상치-탐지-기법-거리군집서포트벡터-기반-이상치탐지"
    title: "[머신러닝] 거리•군집•서포트벡터 기반 이상탐지 기법"
