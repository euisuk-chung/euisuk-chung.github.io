...
description: "Ubuntu에서 Miniconda와 Miniforge의 차이를 설명하고, Miniforge 설치 스크립트 실행, PATH 설정, 가상환경 생성, base 자동 활성화 해제, conda-forge 채널 관리까지 분석 환경 구성 절차를 안내한다."
date: "2024-03-06"
tags:
  - "환경설정"
  - "Linux"
  - "Python"
resource: "https://velog.io/@euisuk-chung/Conda-Miniconda-그리고-Miniforge를-이용한-분석-환경-설정하기-OS-Ubuntu"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:04:26Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/Conda-Miniconda-그리고-Miniforge를-이용한-분석-환경-설정하기-OS-Ubuntu"
    title: "[Conda] Miniforge를 이용한 분석 환경 설정하기 (OS: Ubuntu)"
