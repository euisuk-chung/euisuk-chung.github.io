...
description: "리눅스 lsof 명령어로 디렉토리·파일·포트·사용자·PID별로 열린 리소스를 점유한 프로세스를 찾는 방법과 watch를 조합한 실시간 추적, kill -9 사용 시 주의점을 정리했다."
date: "2024-01-17"
tags:
  - "Linux"
  - "환경설정"
  - "꿀팁"
resource: "https://velog.io/@euisuk-chung/uqqb19in"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:08:38Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/uqqb19in"
    title: "[Linux] 열려 있는 파일 및 리소스 관리의 필수 도구(lsof)"
