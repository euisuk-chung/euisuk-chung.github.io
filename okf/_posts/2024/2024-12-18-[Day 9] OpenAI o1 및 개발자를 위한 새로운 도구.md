...
description: "API로 공개된 o1 모델의 함수 호출·구조화 출력·비전·reasoning_effort, WebRTC 기반 Realtime API와 가격 인하, Preference Fine-Tuning과 SFT의 차이, Go·Java SDK 예제를 정리한다."
date: "2024-12-18"
tags:
  - "OpenAI"
  - "ChatGPT"
resource: "https://velog.io/@euisuk-chung/Day-9-OpenAI-o1-and-dev-tools"
generated:
  by: "process:velog-sync"
  at: "2024-12-21T17:34:36+09:00"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/Day-9-OpenAI-o1-and-dev-tools"
    title: "[Day 9] OpenAI o1 및 개발자를 위한 새로운 도구"
