...
description: "Facebook Prophet의 추세·계절성·휴일 효과 기능을 소개하고 파나마 전력 부하 데이터에 날씨 변수를 외생 회귀변수로 추가해 학습, 예측, Plotly·Matplotlib 시각화, MSE 평가까지 수행한다."
date: "2024-07-12"
tags:
  - "시계열"
  - "머신러닝"
  - "Python"
  - "Visualization"
resource: "https://velog.io/@euisuk-chung/Prophet을-활용한-시계열-예측"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T21:24:32Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/Prophet을-활용한-시계열-예측"
    title: "Prophet을 활용한 시계열 예측🔭"
