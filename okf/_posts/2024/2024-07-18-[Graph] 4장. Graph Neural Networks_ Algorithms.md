...
description: "GCN의 스펙트럴·공간 기반 합성곱, GGNN·Tree LSTM·Graph LSTM 같은 그래프 순환 신경망, GAT의 어텐션 메커니즘을 수식과 PyTorch 구현 예시로 정리한다."
date: "2024-07-18"
tags:
  - "Graph"
  - "딥러닝"
  - "PyTorch"
  - "개념정리"
resource: "https://velog.io/@euisuk-chung/Graph-Neural-Networks-Algorithms"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:55:38Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/Graph-Neural-Networks-Algorithms"
    title: "[Graph] 4장. Graph Neural Networks: Algorithms"
