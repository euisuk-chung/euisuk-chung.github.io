...
description: "정상 데이터 분포의 경계를 학습해 경계 밖 점을 이상치로 판별하는 One-Class SVM의 원리와 scikit-learn OneClassSVM의 매개변수, 속성, 메서드, 예제 코드를 정리한다."
date: "2024-05-14"
tags:
  - "이상탐지"
  - "머신러닝"
  - "비지도학습"
  - "Python"
resource: "https://velog.io/@euisuk-chung/결정-경계-기반-이상탐지-알고리즘"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:59:45Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/결정-경계-기반-이상탐지-알고리즘"
    title: "[이탐] 결정 경계 기반 이상탐지 알고리즘"
