...
description: "의사결정나무부터 랜덤 포레스트, AdaBoost, XGBoost, LightGBM, CatBoost, HGBT까지 트리 기반 알고리즘의 역사와 원리를 장단점과 함께 정리하고 scikit-learn 예제로 성능을 비교한다."
date: "2024-06-24"
tags:
  - "머신러닝"
  - "개념정리"
  - "Python"
resource: "https://velog.io/@euisuk-chung/트리-트리-기반-ML-알고리즘"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:57:45Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/트리-트리-기반-ML-알고리즘"
    title: "[트리] 트리 기반 ML 알고리즘"
