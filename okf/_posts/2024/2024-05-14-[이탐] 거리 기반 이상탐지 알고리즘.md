...
description: "K-Means 클러스터링과 KNN(NearestNeighbors)을 활용한 거리 기반 이상탐지의 원리와 적합한 데이터, scikit-learn 매개변수·속성·메서드와 예제 코드, 두 방법의 차이를 정리한다."
date: "2024-05-14"
tags:
  - "이상탐지"
  - "머신러닝"
  - "비지도학습"
  - "Python"
resource: "https://velog.io/@euisuk-chung/군집화-기반-이상탐지-알고리즘-sbjqco5v"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:00:16Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/군집화-기반-이상탐지-알고리즘-sbjqco5v"
    title: "[이탐] 거리 기반 이상탐지 알고리즘"
