...
description: "지역적 밀도 차이로 이상치를 찾는 DBSCAN과 LOF(Local Outlier Factor)의 원리와 적합한 데이터, scikit-learn 구현의 매개변수·속성·메서드와 예제 코드를 정리한다."
date: "2024-05-14"
tags:
  - "이상탐지"
  - "머신러닝"
  - "비지도학습"
  - "Python"
resource: "https://velog.io/@euisuk-chung/밀도-기반-이상탐지-알고리즘"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:00:44Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/밀도-기반-이상탐지-알고리즘"
    title: "[이탐] 밀도 기반 이상탐지 알고리즘"
