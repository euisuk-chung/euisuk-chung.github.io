...
description: "그래프의 노드·에지 표현과 차수, 경로, 연결 성분, 중심성 지표를 정의하고 스펙트럴 그래프 이론, 그래프 푸리에 변환, 이질·이분·하이퍼그래프 등 복잡한 그래프 유형과 GNN 과업을 소개한다."
date: "2024-07-17"
tags:
  - "Graph"
  - "딥러닝"
  - "개념정리"
  - "수학"
resource: "https://velog.io/@euisuk-chung/1장.-그래프와-GNN"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:56:22Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/1장.-그래프와-GNN"
    title: "[Graph] 1장. 그래프와 GNN"
