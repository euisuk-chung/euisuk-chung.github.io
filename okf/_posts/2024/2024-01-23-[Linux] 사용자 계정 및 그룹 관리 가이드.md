...
description: "adduser, visudo, userdel, usermod, groupadd 등 리눅스 계정·그룹 관리 명령어와 sudo 권한 부여, 계정 잠금·만료일 설정, 로그인 기록 확인 방법을 예시와 함께 정리했다."
date: "2024-01-23"
tags:
  - "Linux"
  - "환경설정"
resource: "https://velog.io/@euisuk-chung/리눅스-사용자-계정-관련-소스"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:08:06Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/리눅스-사용자-계정-관련-소스"
    title: "[Linux] 사용자 계정 및 그룹 관리 가이드"
