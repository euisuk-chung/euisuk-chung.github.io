...
description: "신호처리의 목적과 응용 분야를 소개한 뒤 푸리에 변환의 정의, 오일러 공식을 통한 실수부·허수부 해석, 진폭과 위상 계산, 역 푸리에 변환을 설명하고 NumPy FFT 예제로 확인한다."
date: "2024-05-31"
tags:
  - "개념정리"
  - "수학"
  - "시계열"
  - "NumPy"
resource: "https://velog.io/@euisuk-chung/신호처리-및-푸리에-변환"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T18:58:26Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/신호처리-및-푸리에-변환"
    title: "[개념] 신호처리 및 푸리에 변환"
