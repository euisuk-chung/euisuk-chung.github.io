...
```math
\mathcal L_{\mathrm{OPD}}=\mathbb E\left[\left\|\mathbf v_\theta(\mathrm{sg}(\hat{\mathbf x}_{\theta,t}),t,\mathbf c)-\mathbf v_m(\mathrm{sg}(\hat{\mathbf x}_{\theta,t}),t,\mathbf c)\right\|_2^2\right].
```
