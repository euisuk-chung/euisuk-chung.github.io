---
type: "Repo Review"
title: "[Repo Review] Superpowers 코드 리뷰: 코딩 에이전트의 개발 절차를 스킬과 파일로 구성하는 방법"
...
tags:
  ...
  - "Prompt Engineering"
  - "Tools"
resource: "https://github.com/obra/superpowers/tree/b36e0829c6d0140e93cfef2ca599b1b07d4a7797"
generated:
  by: "process:blog-review"
  at: "2026-09-11T06:08:58+09:00"
sources:
  - id: "obra/superpowers"
    resource: "https://github.com/obra/superpowers/tree/b36e0829c6d0140e93cfef2ca599b1b07d4a7797"
...
visual_sources:
  - path: "/img/reviews/2026/superpowers-review/control-flow.svg"
    kind: "reviewer-diagram"
    source_url: "https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/SKILL.md#L246-L310"
    caption: "리뷰어 작성, 분석 커밋 기준: 플랫폼 초기화와 파일 기반 SDD 작업·리뷰 흐름"
    evidence:
      - "https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/hooks/session-start#L6-L47"
      - "https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/scripts/task-brief#L17-L41"
      - "https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/scripts/review-package#L17-L46"
---
...
[![Superpowers의 초기화 코드가 스킬을 전달하고 컨트롤러가 요구사항·보고서·diff 파일로 구현과 리뷰를 연결하는 흐름]({{ '/img/reviews/2026/superpowers-review/control-flow.svg' | relative_url }})]({{ '/img/reviews/2026/superpowers-review/control-flow.svg' | relative_url }})

*그림 1. 리뷰어 작성, 분석 커밋 기준. 파란 상자는 코드가 수행하는 처리, 녹색은 파일과 기록, 노란색은 모델이 따르는 자연어 절차입니다. 그림을 누르면 확대할 수 있습니다. 근거: [세션 초기화](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/hooks/session-start#L6-L47), [작업 추출](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/scripts/task-brief#L17-L41), [리뷰 패키지 생성](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/scripts/review-package#L17-L46), [구현자·리뷰어 호출 지침](https://github.com/obra/superpowers/blob/b36e0829c6d0140e93cfef2ca599b1b07d4a7797/skills/subagent-driven-development/SKILL.md#L246-L310).*

그림은 초기 스킬 전달 이후 **상세 계획을 사용하는 SDD 경로**를 연결합니다. `task-brief`와 `review-package`가 만드는 파일은 작업의 요구사항과 변경 범위를 보존합니다. 이 파일을 읽고 구현자를 호출하거나 수정 여부를 판단하는 주체는 지침을 따르는 컨트롤러입니다. 따라서 코드가 직접 보장하는 파일 처리와 모델의 절차 준수를 색으로 구분했습니다. OpenCode·Pi·Codex의 초기화 차이는 아래에서 별도로 설명합니다.
