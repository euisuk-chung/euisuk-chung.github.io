...
description: "OpenAI 공식 GPT-5.2 프롬프팅 가이드를 바탕으로 상세도 제어, 범위 이탈 방지, 긴 컨텍스트 처리, 환각 완화 프롬프트 패턴과 Compaction, reasoning_effort 기반 마이그레이션 전략을 정리한다."
date: "2026-01-17"
tags:
  - "Prompt Engineering"
  - "OpenAI"
  - "AI Agent"
resource: "https://velog.io/@euisuk-chung/OpenAI-GPT-5.2-프롬프팅-가이드-엔터프라이즈-AI-에이전트를-위한-최적화-전략"
generated:
  by: "process:velog-sync"
  at: "2026-02-16T22:50:35Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/OpenAI-GPT-5.2-프롬프팅-가이드-엔터프라이즈-AI-에이전트를-위한-최적화-전략"
    title: "[OpenAI] GPT-5.2 프롬프팅 가이드: 엔터프라이즈 AI 에이전트를 위한 최적화 전략"
