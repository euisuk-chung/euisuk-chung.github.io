...
description: "다변량 시계열의 각 변수를 GridSpec 서브플롯에 그리고 IForest 등 모델이 탐지한 이상치를 빨간 점으로 표시하는 matplotlib 함수와 viridis 컬러맵, suptitle 겹침 해결법을 정리한다."
date: "2023-11-13"
tags:
  - "이상탐지"
  - "시계열"
  ...
  - "Snippet"
  - "Python"
resource: "https://velog.io/@euisuk-chung/TS-시계열-이상탐지-시각화"
generated:
  by: "process:velog-sync"
  at: "2026-02-18T19:09:53Z"
sources:
  - id: "velog"
    resource: "https://velog.io/@euisuk-chung/TS-시계열-이상탐지-시각화"
    title: "[TS] 시계열 이상탐지 시각화"
