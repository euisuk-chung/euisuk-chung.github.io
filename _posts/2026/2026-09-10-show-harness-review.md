---
layout: post
title: 'Show-Harness 논문 리뷰: 의미 기반 행동 인터페이스로 VLM과 로봇을 연결하기'
summary: 'VLM의 판단을 작은 로봇 동작으로 연결하는 Show-Harness의 인터페이스, 실험, 부록을 원문 순서대로 분석합니다.'
tags: [논문리뷰, Robotics, VLM, EmbodiedAI]
