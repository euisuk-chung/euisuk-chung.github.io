...
* **초기화 공식**:
  ...
  w∼N(0,1Nin)w \sim N(0, \frac{1}{N\_{in}})w∼N(0,Nin​1​)
...
* 여기서 가중치 wijw\_{ij}wij​가 큰 분산을 가지면, zjz\_jzj​의 분산도 증가합니다.
  ...
  + 만약 wij∼N(0,σw2)w\_{ij} \sim \mathcal{N}(0, \sigma\_w^2)wij​∼N(0,σw2​)이라면:

    Var[zj]=Nin⋅Var[w]⋅Var[x]\text{Var}[z\_j] = N\_{in} \cdot \text{Var}[w] \cdot \text{Var}[x]Var[zj​]=Nin​⋅Var[w]⋅Var[x]
...
* **LeCun 초기화 (2종류)**
  ...
  + 정규분포를 따르는 경우:
    ...
    wij∼N(0,1Nin)w\_{ij} \sim \mathcal{N}(0, \frac{1}{N\_{in}})wij​∼N(0,Nin​1​)
  + 균등분포를 따르는 경우:

    wij∼U(−1Nin,1Nin)w\_{ij} \sim \mathcal{U} \left(-\frac{1}{\sqrt{N\_{in}}}, \frac{1}{\sqrt{N\_{in}}} \right)wij​∼U(−Nin​​1​,Nin​​1​)
...
* **초기화 공식**:
  ...
  w∼N(0,2Nin+Nout)w \sim N(0, \frac{2}{N\_{in} + N\_{out}})w∼N(0,Nin​+Nout​2​)
...
* **초기화 공식**:
  ...
  w∼N(0,2Nin)w \sim N(0, \frac{2}{N\_{in}})w∼N(0,Nin​2​)
